...
{
    BOOST_CHECK(TestSplitHost("www.koyotecoin.org", "www.koyotecoin.org", 0));
    BOOST_CHECK(TestSplitHost("[www.koyotecoin.org]", "www.koyotecoin.org", 0));
    BOOST_CHECK(TestSplitHost("www.koyotecoin.org:80", "www.koyotecoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.koyotecoin.org]:80", "www.koyotecoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:8111", "127.0.0.1", 8111));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:8111", "127.0.0.1", 8111));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:8111", "::ffff:127.0.0.1", 8111));
    BOOST_CHECK(TestSplitHost("[::]:8111", "::", 8111));
    BOOST_CHECK(TestSplitHost("::8111", "::8111", 0));
    BOOST_CHECK(TestSplitHost(":8111", "", 8111));
    BOOST_CHECK(TestSplitHost("[]:8111", "", 8111));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:8111", "127.0.0.1:8111"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:8111", "[::]:8111"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
