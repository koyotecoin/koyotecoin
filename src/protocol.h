...
#ifndef KOYOTECOIN_PROTOCOL_H
#define KOYOTECOIN_PROTOCOL_H
...
/**
 * Koyotecoin protocol message types. When adding new message types, don't forget
 ...
 * @since protocol version 10000 as described by BIP37.
 */
 ...
 * @since protocol version 10000 as described by BIP31.
 */
 ...
 * @since protocol version 10000 as described by BIP130.
 */
extern const char* SENDHEADERS;
/**
 * The feefilter message tells the receiving peer not to inv us any txs
 * which do not meet the specified min fee rate.
 * @since protocol version 10000 as described by BIP133
 */
 ...
 * @since protocol version 10000 as described by BIP 152
 */
 ...
 * txid.
 * @since protocol version 10000 as described by BIP 339.
 */
...
enum ServiceFlags : uint64_t {
    ...
    // set by all Koyotecoin Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    ...
    // koyotecoin-development mailing list. Remember that service bits are just
