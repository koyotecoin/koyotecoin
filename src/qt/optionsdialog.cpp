    ...
    mapper(nullptr)
{
    ...
    ui->koyotecoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->koyotecoinAtStartup);
    ...
    ui->koyotecoinAtStartup->setToolTip(ui->koyotecoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->koyotecoinAtStartup->setText(ui->koyotecoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openKoyotecoinConfButton->setToolTip(ui->openKoyotecoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new KoyotecoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->koyotecoinAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_pskt_controls, OptionsModel::EnablePSKYControls);
...
void OptionsDialog::on_openKoyotecoinConfButton_clicked()
{
