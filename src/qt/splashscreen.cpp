    ...
    : QWidget(), curAlignment(0)
{
    ...
    QString copyrightText = QString::fromUtf8(CopyrightHoldersSplashScreen(strprintf("\xc2\xA9 %u-%u ", 2023, COPYRIGHT_YEAR)).c_str());
    ...
    QRect rectIcon(QPoint(-65, -45), QSize(300, 300));
