...
#ifndef KOYOTECOIN_QT_OPTIONSMODEL_H
#define KOYOTECOIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Koyotecoin client.
...
public:
    ...
    KoyotecoinUnit getDisplayUnit() const { return m_display_koyotecoin_unit; }
...
private:
    ...
    QString language;
    KoyotecoinUnit m_display_koyotecoin_unit;
...
Q_SIGNALS:
    void displayUnitChanged(KoyotecoinUnit unit);
    void coinControlFeaturesChanged(bool);
    void showTrayIconChanged(bool);
    void useEmbeddedMonospacedFontChanged(bool);
};

#endif // KOYOTECOIN_QT_OPTIONSMODEL_H
