...
#ifndef KOYOTECOIN_QT_KOYOTECOINGUI_H
#define KOYOTECOIN_QT_KOYOTECOINGUI_H
...
/**
  Koyotecoin GUI main class. This class represents the main window of the Koyotecoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class KoyotecoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit KoyotecoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~KoyotecoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a koyotecoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, KoyotecoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(KoyotecoinUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // KOYOTECOIN_QT_KOYOTECOINGUI_H
