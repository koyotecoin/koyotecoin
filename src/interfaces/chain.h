...
#ifndef KOYOTECOIN_INTERFACES_CHAIN_H
#define KOYOTECOIN_INTERFACES_CHAIN_H
...
//! internal workings of the koyotecoin node, and not being very convenient to use.
...
#endif // KOYOTECOIN_INTERFACES_CHAIN_H
