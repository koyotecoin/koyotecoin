...
class NetTest(KoyotecoinTestFramework):
    ...
    def test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(address=ipv6_addr, port=8111)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 8111)
    ...
    def test_addpeeraddress(self):
        ...
        assert_equal(node.addpeeraddress(address="", port=8111), {"success": False})
