...
class RawTransactionsTest(KoyotecoinTestFramework):
    ...
    def createrawtransaction_tests(self):
        ...
        assert_raises_rpc_error(-5, "Invalid Koyotecoin address", self.nodes[0].createrawtransaction, [], {'foo': 0})
    ...
    def sendrawtransaction_testmempoolaccept_tests(self):
        ...
        # Fee rate is 0.00100000 KYC/kvB
        ...
        # Fee rate is 0.20000000 KYC/kvB
    ...
    def decoderawtransaction_tests(self):
        ...
        assert_equal(decrawtx['vout'][0]['value'], Decimal('1.00000000'))
        # known ambiguous transaction in the chain
    ...
    def raw_multisig_transaction_legacy_tests(self):
        ...
        # The multisig workflow with descriptor wallets uses PSKTs and is tested elsewhere, no need to do them here.
