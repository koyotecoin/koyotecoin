...
Assumeutxo is a feature that allows fast bootstrapping of a validating koyotecoind
...
considered active. This is the "traditional" mode of operation for koyotecoind.
...
**Failure consideration:** if koyotecoind unexpectedly halts after `m_stop_use` is set on
...
### Koyotecoind restarts sometime after snapshot validation has completed

When koyotecoind initializes again, what began as the snapshot chainstate is now
