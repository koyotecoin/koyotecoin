...
export TEST_RUNNER_EXTRA="--exclude feature_init,rpc_bind,feature_bind_extra"  # Excluded for now
export RUN_FUNCTIONAL_TESTS=true
export GOAL="install"
export KOYOTECOIN_CONFIG="--enable-reduce-exports --disable-gui-tests"  # GUI tests disabled for now
