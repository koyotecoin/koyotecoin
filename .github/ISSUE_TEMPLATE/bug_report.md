...
<!-- This issue tracker is only for technical issues related to Koyotecoin Core.
...
<!-- What version of Koyotecoin Core are you using, where did you get it (website, self-compiled, etc)? -->
